...
//    {
//        $this->folder = $this->folderPath . ".appearance.editor.";
//    }
//
...
//    {
//        $public_path = public_path() . "/assets/frontend";
//
//        return  [
//            'folders' => [
...
//            'styles' =>  [
//                "$public_path/css",
//                expandDirectoriesMatrix("$public_path/css",0,true)
//            ],
//            'scripts' =>  [
//                "$public_path/js",
//                expandDirectoriesMatrix("$public_path/js",0,true)
//            ],
////            'images' =>  [
////                "$public_path/img",
////                expandDirectoriesMatrix("$public_path/img",0,true)
////            ],
//        ];
//    }
//
