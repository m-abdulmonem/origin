            ...
            <div class="col-8 ">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                       placeholder="@lang("Title")" name="title" value="{{ old("title") }}">
                                @error('title')
                        ...
                        <div class="col-12">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control @error('link') is-invalid @enderror" id="link"
                                       placeholder="@lang("Permalink")" name="link" value="{{ old("link") }}">
                                @error('link')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group ">
                                @php $categories = \Mabdulmonem\Uploader\Http\Models\Product\Category\Category::all()->pluck("title","id") @endphp
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          id="description" placeholder="@lang("Description")" name="description"
