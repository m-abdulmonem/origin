@extends('resources.views.dashboard.layouts.app')
@section('content')
    <!-- Default box -->
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            @foreach($variant->slugs as $key => $slug)
                                <label class="btn btn-default text-center {{ $key == 0? "active" : "" }}">
                                    <input type="radio" name="{{ $variant }}_option"
                                           id="{{ $variant }}_option_a{{$key}}"
            ...
            <div class="row mt-4">
                ...
                <div class="tab-content p-3" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="product-rating" role="tabpanel"
                        ...
                        lectus, vitae hendrerit nisl. Nullam metus odio, malesuada in vehicula at, consectetur nec
                        justo.
